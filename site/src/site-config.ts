...
export const config: SiteConfig = {
  ...
  npmUrl: 'https://www.npmjs.com/package/@mcptoolshop/claude-guardian',
  footerText: 'MIT Licensed — built by <a href="https://mcp-tool-shop.github.io/" style="color:var(--color-muted);text-decoration:underline">MCP Tool Shop</a>',

  hero: {
    badge: 'v1.1.1 — npm package',
  ...
  sections: [
    ...
    },
    {
      ...
      subtitle: 'Ship Gate audit — 49/50.',
      ...
      rows: [
        ...
        ['D. Shipping Hygiene', '9/10', 'CI + tests (152), npm published, Codecov coverage'],
